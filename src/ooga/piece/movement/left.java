...
/**
 * Represents a leftwards movement on the board
...
public class left implements Movement {
    ...
    /**
     * Returns all of the possible paths that a piece can take in the leftwards direction
     ...
     * @return valid paths for a leftward movement
     */
    @Override
