...
/**
 * Represents a backwards movement on the board
...
public class bk implements Movement {
    ...
    /**
     * Returns all of the possible paths that a piece can take in the backwards direction
     ...
     * @return valid paths for a backward movement
     */
    @Override
