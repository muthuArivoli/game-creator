...
/**
 * Represents a backwards movement towards the left along the diagonal on the board
...
public class diagBkLeft implements Movement {
  ...
  /**
   * Returns all of the possible paths that a piece can take in the direction of diagonal backward toward the left
   ...
   * @return valid paths for a left diagonal backward movement
   */
  @Override
